...
class LightweightUNet(nn.Module):
    ...
    def __init__(self, in_channels=1, out_channels=1):
        ...
        self.dec4 = self._block(128, 64)  # 128 = 64 + 64 (skip connection)
        self.upconv3 = nn.ConvTranspose2d(64, 32, kernel_size=2, stride=2)
        self.dec3 = self._block(64, 32)   # 64 = 32 + 32 (skip connection)
        self.upconv2 = nn.ConvTranspose2d(32, 16, kernel_size=2, stride=2)
        self.dec2 = self._block(32, 16)    # 32 = 16 + 16 (skip connection)
        self.upconv1 = nn.ConvTranspose2d(16, 8, kernel_size=2, stride=2)
        self.dec1 = self._block(16, 8)    # 16 = 8 + 8 (skip connection)
